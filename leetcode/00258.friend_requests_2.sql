...
-- This table contains the ID of the user who sent the request, the ID of the user who received the 
-- request, and the date when the request was accepted.
...
with temp2 as (select id, sum(total) as num
from (
