...
-- foreign keys to the users_id at the Users table. Status is an ENUM (category) type of 
...
-- ('client', 'driver', 'partner'). banned is an ENUM (category) type of ('Yes', 'No').
...
-- NOTE for POSTGRESQL add '::numeric' to cast as type double or float. Ignore for MYSQL
...
round(count(
    ...
    )::numeric / count(id), 2) as "Cancellation Rate"
from Trips as T
