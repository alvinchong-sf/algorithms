...
lexicographically larger than "abcc" because the first position they differ is at the fourth character, and d is greater than c.
...
class Solution:
    def largestMerge(self, word1: str, word2: str) -> str:
        ...
        result = []
        while i < n1 and j < n2:
            res = self.compute_larger(word1, word2, i, j, n1, n2)
            if res == 0:
    ...
    def compute_larger(self, word1, word2, idx1, idx2, n1, n2):
