...
-- turn determines the order of which the people will board the bus, where turn=1 denotes the first 
-- person to board and turn=n denotes the last person to board.
...
from (
    ...
    order by Q1.turn desc, Q2.turn desc
) as temp
where temp.total_weight <= 1000
limit 1