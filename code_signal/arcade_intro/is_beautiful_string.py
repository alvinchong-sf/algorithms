...
# Although there are more bs than cs, this string is not beautiful because there are 
# no as, so therefore there are more bs than as.

import string

def solution(inputString):
    alphabet = string.ascii_lowercase
    arr = [0 for i in range(len(alphabet))]
