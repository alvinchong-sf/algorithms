-- You are managing a small newspaper subscription service. Anyone who uses it can subscribe 
-- to a large number of different newspapers for a full year or just a half year.
