...
-- Your professor gave the class a bonus task: Write a program that will check the answers for the latest 
-- test. The program will be given a table answers with the following columns:
...
-- Your task is to return the table with a column id and a column checks, where for each answers id the 
-- following string should be returned:
