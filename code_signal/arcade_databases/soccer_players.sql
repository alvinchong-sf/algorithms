...
-- Create a semicolon-separated list of all the players, sorted by their numbers, and put 
-- this list in a table under a column called players. The information about each player 
-- should have the following format: first_name surname #number.
