# Once upon a time, in a kingdom far, far away, there lived a King Byteasar I. As a 
# kind and wise ruler, he did everything in his (unlimited) power to make life for 
# his subjects comfortable and pleasant. One cold evening a messenger arrived at the 
# king's castle with the latest news: all kings in the Kingdoms Union had started 
# enforcing traffic laws! In order to not lose his membership in the Union, 
# King Byteasar decided he must do the same within his kingdom. But what would the 
...
# roads, and now he needs to make sure that the road system is convenient and there
# will be no traffic jams, i.e. each city has the same number of incoming and outgoing 
# roads. As the Hand of the King, you're the one who he has decreed must check his 
# calculations.
